...
\item \textbf{Fall 2021}:
	...
	\item RF1 Problem \ref{prob:F21.RF1}
	\item RF2 Problem \ref{prob:F21.RF2}
	\item RF3 Problem \ref{prob:F21.RF3}
	\item LA1 Problem \ref{prob:F21.LA1}
	\item LA2 Problem \ref{prob:F21.LA2}
	\item LA3 Problem \ref{prob:F21.LA3}	
	\end{itemize}
